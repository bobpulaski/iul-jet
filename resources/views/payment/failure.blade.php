...
<head>
    ...
    <link rel="canonical" href="https://quatros.ru/payment/failure">


    <title>{{ config('app.name', 'Что-то пошло не так') }}</title>
...
<div class="text-black/80 dark:bg-black dark:text-white/50">
    ...
    <section id="hero" class="md:h-screen">
        ...
        <div class="mx-auto max-w-screen-lg px-4 sm:px-6 lg:px-8">
            <h1 class="flex flex-col text-center text-5xl font-extrabold mt-12 text-slate-500">
                Что-то пошло не так...
            </h1>
            <div class="mt-8 flex flex-col items-center justify-between gap-8">
                <a href="/thanks" class="font-medium text-sky-700 underline">Еще раз</a>
            </div>
