<div class="max-w-3xl overflow-hidden bg-white shadow-xl dark:bg-gray-800 sm:rounded-lg">
    <div class="p-6">
        ...
        <form method="POST" action="/iul-submit">
            @csrf
            ...
            <div class="flex flex-row gap-4 mt-4">
                <div class="basis-full">
                    <x-label for="order-number" value="{{ __('Наименование документа*') }}" />
                    <x-input id="order-number" class="block w-full mt-1" type="text" name="order-number"
                        :value="old('order-number')" required autofocus autocomplete="name" />
                </div>
                <div class="basis-1/4">
            ...
            <div class="flex flex-row gap-4 mt-4">
                <input checked id="algorithm-radio-crc32" type="radio" value="" name="algorithm-radio"
                ...
                <input id="algorithm-radio-md5" type="radio" value="" name="algorithm-radio"
                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600 focus:ring-2 focus:ring-blue-500">
                <label for="default-radio-2"
                    class="text-sm font-medium text-gray-900 dark:text-gray-300 ms-2">MD5</label>

                <input id="algorithm-radio-sha1" type="radio" value="" name="algorithm-radio"
                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600 focus:ring-2 focus:ring-blue-500">
                <label for="default-radio-2"
            ...
            <div class="flex flex-row gap-4 mt-4">
                <div class="basis-full">
                    <x-input id="file-add" class="w-full mt-1" type="file" name="file-add" :value="old('file-add')"
