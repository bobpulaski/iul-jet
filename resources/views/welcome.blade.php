...
<head>
    ...
    <meta name="description"
        content="Конструктор ИУЛ для экспертизы онлайн. Сформируйте и скачайте информационно-удостоверяющий лист с любого устройства на нашем сайте Quartos.">
...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        ...
        <div
            ...
            <main class="mt-6">
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    <h1 class="text-2xl">Конструктор ИУЛ для проектно-сметной документации</h1>
                </div>
            </main>
